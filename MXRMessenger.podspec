...
Pod::Spec.new do |s|
  s.name             = 'MXRMessenger'
  s.version          = '0.1.0'
  s.summary          = 'A short description of MXRMessenger.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Scott Kensell/MXRMessenger'
  ...
  s.source_files = 'MXRMessenger/Classes/**/*'
  
  # s.resource_bundles = {
  #   'MXRMessenger' => ['MXRMessenger/Assets/*.png']
  # }
